...
import '../models/mobiletextlist1_item_model.dart';
import 'package:ecommerce_seller_app/core/app_export.dart';
import 'package:ecommerce_seller_app/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class Mobiletextlist1ItemWidget extends StatelessWidget {
  Mobiletextlist1ItemWidget(
    this.mobiletextlist1ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Mobiletextlist1ItemModel mobiletextlist1ItemModelObj;
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => Text(
                      mobiletextlist1ItemModelObj.mobileText!.value,
