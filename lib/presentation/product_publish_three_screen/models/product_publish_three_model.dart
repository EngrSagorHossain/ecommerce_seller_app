import '../../../core/app_export.dart';import 'productcard5_item_model.dart';import 'package:ecommerce_seller_app/data/models/selectionPopupModel/selection_popup_model.dart';/// This class defines the variables used in the [product_publish_three_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class ProductPublishThreeModel {Rx<List<Productcard5ItemModel>> productcard5ItemList = Rx([Productcard5ItemModel(imageClass:ImageConstant.imgInfo.obs,productName: "Chanachur".obs,productPrice: "10.00".obs,productAvailability: "Left 232".obs,minusSign: "- ".obs,quantity: "1".obs,plusSign: "+".obs),Productcard5ItemModel(imageClass:ImageConstant.imgProfile.obs,productName: "Biscuits".obs,productPrice: "10.00".obs,productAvailability: "Left 232".obs,minusSign: "- ".obs,quantity: "1".obs,plusSign: "+".obs),Productcard5ItemModel(imageClass:ImageConstant.imgInfo.obs,productName: "Chips".obs,productPrice: "10.00".obs,productAvailability: "Left 232".obs,minusSign: "- ".obs,quantity: "1".obs,plusSign: "+".obs),Productcard5ItemModel(imageClass:ImageConstant.imgInfo.obs,productName: "Cake".obs,productPrice: "10.00".obs,productAvailability: "Left 232".obs,minusSign: "- ".obs,quantity: "1".obs,plusSign: "+".obs)]);
