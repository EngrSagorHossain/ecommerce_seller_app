import '../product_publish_three_screen/widgets/productcard5_item_widget.dart';
...
class ProductPublishThreeScreen
    extends GetWidget<ProductPublishThreeController> {
  const ProductPublishThreeScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _buildPublishPackage(),
      ),
    );
  }
        ...
        SizedBox(
          ...
          child: Obx(
            () => ListView.separated(
              ...
              itemCount: controller.productPublishThreeModelObj.value
                  .productcard5ItemList.value.length,
              itemBuilder: (context, index) {
                Productcard5ItemModel model = controller
                    .productPublishThreeModelObj
                    .value
                    .productcard5ItemList
                    .value[index];
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDown(
              ...
              items: controller
                  .productPublishThreeModelObj.value.dropdownItemList!.value,
              onChanged: (value) {
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDown(
              ...
              items: controller
                  .productPublishThreeModelObj.value.dropdownItemList1!.value,
              onChanged: (value) {
