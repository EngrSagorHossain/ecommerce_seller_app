import '../add_policy_one_screen/widgets/userprofile2_item_widget.dart';
...
class AddPolicyOneScreen extends GetWidget<AddPolicyOneController> {
  const AddPolicyOneScreen({Key? key})
      : super(
          key: key,
        );
          ...
          SizedBox(
            ...
            child: Obx(
              () => ListView.separated(
                ...
                itemCount: controller.addPolicyOneModelObj.value
                    .userprofile2ItemList.value.length,
                itemBuilder: (context, index) {
                  Userprofile2ItemModel model = controller.addPolicyOneModelObj
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDown(
              ...
              items:
                  controller.addPolicyOneModelObj.value.dropdownItemList!.value,
              onChanged: (value) {
