import '../added_policy_two_screen/widgets/productcard9_item_widget.dart';
...
class AddedPolicyTwoScreen extends GetWidget<AddedPolicyTwoController> {
  const AddedPolicyTwoScreen({Key? key})
      : super(
          key: key,
        );
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildNoReturnOptionCheckBox(),
                  SizedBox(height: 18.v),
                  _buildDeliveryOptionColumn(),
                  SizedBox(height: 19.v),
                  _buildNameColumn(),
                  SizedBox(height: 19.v),
                  _buildGroup331Column(),
        ...
        SizedBox(
          ...
          child: Obx(
            () => ListView.separated(
              ...
              itemCount: controller.addedPolicyTwoModelObj.value
                  .productcard9ItemList.value.length,
              itemBuilder: (context, index) {
                Productcard9ItemModel model = controller.addedPolicyTwoModelObj
                    .value.productcard9ItemList.value[index];
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDown(
              ...
              items: controller
                  .addedPolicyTwoModelObj.value.dropdownItemList!.value,
              onChanged: (value) {
  ...
  /// Section Widget
  Widget _buildNoReturnOptionCheckBox() {
    return Align(
      ...
      child: Padding(
        ...
        child: Obx(
          () => CustomCheckboxButton(
            ...
            value: controller.noReturnOptionCheckBox.value,
            onChange: (value) {
              controller.noReturnOptionCheckBox.value = value;
            },
          ),
        ),
      ),
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropDown(
              ...
              items: controller
                  .addedPolicyTwoModelObj.value.dropdownItemList1!.value,
              onChanged: (value) {
