import 'controller/package_details_two_controller.dart';import 'package:ecommerce_seller_app/core/app_export.dart';import 'package:flutter/material.dart';
// ignore_for_file: must_be_immutable
class PackageDetailsTwoDialog extends StatelessWidget {PackageDetailsTwoDialog(this.controller, {Key? key}) : super(key: key);

PackageDetailsTwoController controller;
...
/// Navigates to the packageDetailsScreen when the action is triggered.
onTapImgCloseOne() { Get.toNamed(AppRoutes.packageDetailsScreen, ); } 
 }
