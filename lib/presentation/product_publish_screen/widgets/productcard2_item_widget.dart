...
class Productcard2ItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<ProductPublishController>();
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Obx(
              () => CustomImageView(
                imagePath: productcard2ItemModelObj.imageClass!.value,
                height: 50.v,
                width: 44.h,
              ),
            ),
            ...
            Obx(
              () => Text(
                productcard2ItemModelObj.productAvailability!.value,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Obx(
                    () => Text(
                      productcard2ItemModelObj.minusSign!.value,
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        productcard2ItemModelObj.quantity!.value,
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        productcard2ItemModelObj.plusSign!.value,
                        style: theme.textTheme.bodySmall,
                      ),
                    ),
                  ),
